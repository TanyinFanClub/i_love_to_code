...
class Diagnosis (db.Model):
    ...
    def json(self):
        return {"QueueID": self.QueueID, "Registration_time": self.Registration_time, "NRIC": self.NRIC, "Initial_diagnosis": self.Initial_diagnosis,
        "Doctor_diagnosis": self.Doctor_diagnosis, "Hospital": self.Hospital, "Nurse_IC": self.Nurse_IC, "Doctor_IC": self.Doctor_IC,
        "Nurse_cleared": self.Nurse_cleared, "Severe": self.Severe, "Complete": self.Complete}
